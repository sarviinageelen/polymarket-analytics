...
Generated from the cached Gamma event snapshot and Nav-backed Parquet trade layer at `2026-08-04T17:44:14.083820+00:00`.
...
- 5+ game candidates: `5` saved in `results/bettor_candidates_5games_70pct.csv`.
- 10+ game candidates: `3` saved in `results/bettor_candidates_10games_70pct.csv`.
