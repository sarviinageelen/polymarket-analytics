...
| Metric | Value |
| --- | ---: |
| Moneyline markets | 2,365 |
| Resolved markets | 2,365 |
...
- Raw event cache: `/root/polymarket-analytics/data/raw/mlb_2025_events.json`
- Experiment directory: `data/experiments/nav_mlb_2025_moneyline`
